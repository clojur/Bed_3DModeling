...
class FastPolytopeIntersector : public osgUtil::Intersector
{
    public:
        ...
        /** Construct a FastPolytopeIntersector using specified polytope in MODEL coordinates.*/
		FastPolytopeIntersector(const osg::Polytope& polytope);

        /** Construct a FastPolytopeIntersector using specified polytope in specified coordinate frame.*/
		FastPolytopeIntersector(CoordinateFrame cf, const osg::Polytope& polytope);
		...
		FastPolytopeIntersector(CoordinateFrame cf, double xMin, double yMin, double xMax, double yMax);
    ...
    protected:
        ...
        FastPolytopeIntersector* _parent;
