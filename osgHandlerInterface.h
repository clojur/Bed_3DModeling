...
//自定义操作基类
class DB_3DMODELING_API  osgHandlerInterface
{
public:
	osgHandlerInterface(CViewControlData* pOSG);
	/*
	命令结束
	*/
	virtual void finish();
...
public:
	...
	std::map<osg::Node* , C3DInterface*> selectetSetMap;
};
...
void DB_3DMODELING_API CopyObjectAndAdd(CViewControlData* m_pOSG, C3DInterface* pCreateData);
